...
const Card = () => {
  return (
    <div className="flex flex-col items-center w-full bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row md:max-w-4xl dark:border-gray-700 dark:bg-gray-800">
